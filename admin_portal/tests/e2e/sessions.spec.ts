...
import { mockGoogleOAuthSession, navigateTo, waitForApiCalls, getTableData } from './helpers'
...
test.describe('Sessions Management', () => {
  ...
  test('should have filter options', async ({ page }) => {
    ...
    const filters = page.locator('select, button:has-text("Filter"), button[aria-label*="filter" i]')
