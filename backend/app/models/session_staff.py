...
class SessionStaff(Base, UUIDPrimaryKey):
    ...
    __table_args__ = (UniqueConstraint("session_id", "staff_id", name="uq_session_staff"),)
    ...
    # Relationships
    session: Mapped[Session] = relationship("Session", back_populates="session_staff_assignments")
