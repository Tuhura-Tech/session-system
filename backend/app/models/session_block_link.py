...
class SessionBlockLink(Base, UUIDPrimaryKey, TimestampMixin):
    ...
    __table_args__ = (UniqueConstraint("session_id", "block_id", name="uq_session_block_links_session_block"),)
    ...
    block: Mapped[SessionBlock] = relationship("SessionBlock", back_populates="session_block_links")

    def __repr__(self) -> str:
        return f"SessionBlockLink(session_id={self.session_id}, block_id={self.block_id})"
