...
from app.domains.admin.schemas.staff import Staff
...
class StaffController(Controller):
    ...
    ) -> service.OffsetPagination[Staff]:
        """List all staff."""
        results, total = await staff_service.list_and_count()
        return staff_service.to_schema(results, total, schema_type=Staff)
