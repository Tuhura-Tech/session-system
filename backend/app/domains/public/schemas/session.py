...
#     day_of_week: int | None, start_time: time | None, end_time: time | None
# ) -> str:
...
#     location_details: SessionLocationDetails | None = Field(
#         None, alias="locationDetails"
#     )
...
#         term_name = (
#             f"{getattr(session, 'year', '')}" if session_type == "term" else None
#         )
...
#                 sorted_links = sorted(
#                     block_links,
#                     key=lambda bl: block_order.get(
#                         getattr(bl.block, "block_type", ""), 99
#                     ),
#                 )
